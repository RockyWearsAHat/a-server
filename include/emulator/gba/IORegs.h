...
inline constexpr uint32_t IWRAM_BIOS_IF =
    0x03007FF8; // Interrupt flags (read by user handler)
inline constexpr uint32_t IWRAM_BIOS_HANDLER =
    0x03007FFC; // User interrupt handler pointer
