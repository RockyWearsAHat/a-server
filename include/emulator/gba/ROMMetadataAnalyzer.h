#pragma once
#include <cstdint>
#include <emulator/gba/SaveType.h>
#include <regex>
#include <string>
#include <vector>
...
enum class Region { Unknown, Japan, NorthAmerica, PAL, Korea };
...
private:
  ...
  static bool Contains(const std::vector<uint8_t> &romData,
                       const std::string &pattern);

  // Helper: Search for regex pattern in ROM and extract matches
  static bool ContainsRegex(const std::vector<uint8_t> &romData,
