...
- Use RAII and value semantics; make ownership and lifetimes explicit.
- Prefer standard containers and algorithms.
- Use profilers like perf, Valgrind, or Intel VTune.
- Enable compiler optimizations (-O2, -O3) but measure impact.
- Use const, constexpr, and move semantics where appropriate.
