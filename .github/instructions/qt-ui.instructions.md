...
- C++ and QObject lifecycle rules for GUI code live in `.github/instructions/qt-cpp.instructions.md`. Use this file for rendered-output and QSS workflow, not as a substitute for Qt ownership rules.
